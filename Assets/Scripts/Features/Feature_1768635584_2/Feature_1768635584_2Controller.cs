using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635584_2 {
    public class Feature_1768635584_2Controller : MonoBehaviour, IFeature_1768635584_2Service {
        [SerializeField] private Feature_1768635584_2View _view;
        private Feature_1768635584_2Model _model;

        public void Initialize() {
            _model = new Feature_1768635584_2Model();
            _view = GetComponent<Feature_1768635584_2View>();
        }
