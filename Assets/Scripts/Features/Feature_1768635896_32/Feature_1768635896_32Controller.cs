using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635896_32 {
    public class Feature_1768635896_32Controller : MonoBehaviour, IFeature_1768635896_32Service {
        [SerializeField] private Feature_1768635896_32View _view;
        private Feature_1768635896_32Model _model;

        public void Initialize() {
            _model = new Feature_1768635896_32Model();
            _view = GetComponent<Feature_1768635896_32View>();
        }
