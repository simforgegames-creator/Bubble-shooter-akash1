using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635366_7 {
    public class Feature_1768635366_7Controller : MonoBehaviour, IFeature_1768635366_7Service {
        [SerializeField] private Feature_1768635366_7View _view;
        private Feature_1768635366_7Model _model;

        public void Initialize() {
            _model = new Feature_1768635366_7Model();
            _view = GetComponent<Feature_1768635366_7View>();
        }
