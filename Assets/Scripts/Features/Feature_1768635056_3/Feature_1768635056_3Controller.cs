using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635056_3 {
    public class Feature_1768635056_3Controller : MonoBehaviour, IFeature_1768635056_3Service {
        [SerializeField] private Feature_1768635056_3View _view;
        private Feature_1768635056_3Model _model;

        public void Initialize() {
            _model = new Feature_1768635056_3Model();
            _view = GetComponent<Feature_1768635056_3View>();
        }
