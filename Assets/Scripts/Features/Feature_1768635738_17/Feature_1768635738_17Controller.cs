using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635738_17 {
    public class Feature_1768635738_17Controller : MonoBehaviour, IFeature_1768635738_17Service {
        [SerializeField] private Feature_1768635738_17View _view;
        private Feature_1768635738_17Model _model;

        public void Initialize() {
            _model = new Feature_1768635738_17Model();
            _view = GetComponent<Feature_1768635738_17View>();
        }
