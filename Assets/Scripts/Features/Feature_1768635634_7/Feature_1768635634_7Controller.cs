using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635634_7 {
    public class Feature_1768635634_7Controller : MonoBehaviour, IFeature_1768635634_7Service {
        [SerializeField] private Feature_1768635634_7View _view;
        private Feature_1768635634_7Model _model;

        public void Initialize() {
            _model = new Feature_1768635634_7Model();
            _view = GetComponent<Feature_1768635634_7View>();
        }
