using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635093_7 {
    public class Feature_1768635093_7Controller : MonoBehaviour, IFeature_1768635093_7Service {
        [SerializeField] private Feature_1768635093_7View _view;
        private Feature_1768635093_7Model _model;

        public void Initialize() {
            _model = new Feature_1768635093_7Model();
            _view = GetComponent<Feature_1768635093_7View>();
        }
