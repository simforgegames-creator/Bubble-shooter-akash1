using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635814_24 {
    public class Feature_1768635814_24Controller : MonoBehaviour, IFeature_1768635814_24Service {
        [SerializeField] private Feature_1768635814_24View _view;
        private Feature_1768635814_24Model _model;

        public void Initialize() {
            _model = new Feature_1768635814_24Model();
            _view = GetComponent<Feature_1768635814_24View>();
        }
