using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635921_34 {
    public class Feature_1768635921_34Controller : MonoBehaviour, IFeature_1768635921_34Service {
        [SerializeField] private Feature_1768635921_34View _view;
        private Feature_1768635921_34Model _model;

        public void Initialize() {
            _model = new Feature_1768635921_34Model();
            _view = GetComponent<Feature_1768635921_34View>();
        }
