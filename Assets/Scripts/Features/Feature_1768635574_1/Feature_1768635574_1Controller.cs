using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635574_1 {
    public class Feature_1768635574_1Controller : MonoBehaviour, IFeature_1768635574_1Service {
        [SerializeField] private Feature_1768635574_1View _view;
        private Feature_1768635574_1Model _model;

        public void Initialize() {
            _model = new Feature_1768635574_1Model();
            _view = GetComponent<Feature_1768635574_1View>();
        }
