using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635113_9 {
    public class Feature_1768635113_9Controller : MonoBehaviour, IFeature_1768635113_9Service {
        [SerializeField] private Feature_1768635113_9View _view;
        private Feature_1768635113_9Model _model;

        public void Initialize() {
            _model = new Feature_1768635113_9Model();
            _view = GetComponent<Feature_1768635113_9View>();
        }
