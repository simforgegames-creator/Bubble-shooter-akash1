using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635867_29 {
    public class Feature_1768635867_29Controller : MonoBehaviour, IFeature_1768635867_29Service {
        [SerializeField] private Feature_1768635867_29View _view;
        private Feature_1768635867_29Model _model;

        public void Initialize() {
            _model = new Feature_1768635867_29Model();
            _view = GetComponent<Feature_1768635867_29View>();
        }
