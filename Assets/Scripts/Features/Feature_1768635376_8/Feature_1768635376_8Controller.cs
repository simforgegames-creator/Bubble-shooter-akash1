using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635376_8 {
    public class Feature_1768635376_8Controller : MonoBehaviour, IFeature_1768635376_8Service {
        [SerializeField] private Feature_1768635376_8View _view;
        private Feature_1768635376_8Model _model;

        public void Initialize() {
            _model = new Feature_1768635376_8Model();
            _view = GetComponent<Feature_1768635376_8View>();
        }
