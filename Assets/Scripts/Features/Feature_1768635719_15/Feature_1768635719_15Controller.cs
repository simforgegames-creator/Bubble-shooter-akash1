using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635719_15 {
    public class Feature_1768635719_15Controller : MonoBehaviour, IFeature_1768635719_15Service {
        [SerializeField] private Feature_1768635719_15View _view;
        private Feature_1768635719_15Model _model;

        public void Initialize() {
            _model = new Feature_1768635719_15Model();
            _view = GetComponent<Feature_1768635719_15View>();
        }
