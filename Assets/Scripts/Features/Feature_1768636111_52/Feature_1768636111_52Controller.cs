using UnityEngine;
namespace BubbleShooter.Features.Feature_1768636111_52 {
    public class Feature_1768636111_52Controller : MonoBehaviour, IFeature_1768636111_52Service {
        [SerializeField] private Feature_1768636111_52View _view;
        private Feature_1768636111_52Model _model;

        public void Initialize() {
            _model = new Feature_1768636111_52Model();
            _view = GetComponent<Feature_1768636111_52View>();
        }
