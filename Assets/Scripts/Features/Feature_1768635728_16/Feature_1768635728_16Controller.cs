using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635728_16 {
    public class Feature_1768635728_16Controller : MonoBehaviour, IFeature_1768635728_16Service {
        [SerializeField] private Feature_1768635728_16View _view;
        private Feature_1768635728_16Model _model;

        public void Initialize() {
            _model = new Feature_1768635728_16Model();
            _view = GetComponent<Feature_1768635728_16View>();
        }
