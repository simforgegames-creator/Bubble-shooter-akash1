using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635170_14 {
    public class Feature_1768635170_14Controller : MonoBehaviour, IFeature_1768635170_14Service {
        [SerializeField] private Feature_1768635170_14View _view;
        private Feature_1768635170_14Model _model;

        public void Initialize() {
            _model = new Feature_1768635170_14Model();
            _view = GetComponent<Feature_1768635170_14View>();
        }
