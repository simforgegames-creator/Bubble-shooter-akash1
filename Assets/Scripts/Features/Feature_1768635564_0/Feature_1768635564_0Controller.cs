using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635564_0 {
    public class Feature_1768635564_0Controller : MonoBehaviour, IFeature_1768635564_0Service {
        [SerializeField] private Feature_1768635564_0View _view;
        private Feature_1768635564_0Model _model;

        public void Initialize() {
            _model = new Feature_1768635564_0Model();
            _view = GetComponent<Feature_1768635564_0View>();
        }
