using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635075_5 {
    public class Feature_1768635075_5Controller : MonoBehaviour, IFeature_1768635075_5Service {
        [SerializeField] private Feature_1768635075_5View _view;
        private Feature_1768635075_5Model _model;

        public void Initialize() {
            _model = new Feature_1768635075_5Model();
            _view = GetComponent<Feature_1768635075_5View>();
        }
