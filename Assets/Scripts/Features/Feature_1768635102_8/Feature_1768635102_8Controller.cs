using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635102_8 {
    public class Feature_1768635102_8Controller : MonoBehaviour, IFeature_1768635102_8Service {
        [SerializeField] private Feature_1768635102_8View _view;
        private Feature_1768635102_8Model _model;

        public void Initialize() {
            _model = new Feature_1768635102_8Model();
            _view = GetComponent<Feature_1768635102_8View>();
        }
