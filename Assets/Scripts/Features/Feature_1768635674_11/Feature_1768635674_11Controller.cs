using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635674_11 {
    public class Feature_1768635674_11Controller : MonoBehaviour, IFeature_1768635674_11Service {
        [SerializeField] private Feature_1768635674_11View _view;
        private Feature_1768635674_11Model _model;

        public void Initialize() {
            _model = new Feature_1768635674_11Model();
            _view = GetComponent<Feature_1768635674_11View>();
        }
