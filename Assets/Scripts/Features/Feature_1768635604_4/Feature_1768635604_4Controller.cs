using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635604_4 {
    public class Feature_1768635604_4Controller : MonoBehaviour, IFeature_1768635604_4Service {
        [SerializeField] private Feature_1768635604_4View _view;
        private Feature_1768635604_4Model _model;

        public void Initialize() {
            _model = new Feature_1768635604_4Model();
            _view = GetComponent<Feature_1768635604_4View>();
        }
