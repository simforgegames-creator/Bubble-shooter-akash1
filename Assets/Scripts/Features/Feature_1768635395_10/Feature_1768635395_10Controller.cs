using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635395_10 {
    public class Feature_1768635395_10Controller : MonoBehaviour, IFeature_1768635395_10Service {
        [SerializeField] private Feature_1768635395_10View _view;
        private Feature_1768635395_10Model _model;

        public void Initialize() {
            _model = new Feature_1768635395_10Model();
            _view = GetComponent<Feature_1768635395_10View>();
        }
