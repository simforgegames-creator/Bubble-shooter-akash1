using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635084_6 {
    public class Feature_1768635084_6Controller : MonoBehaviour, IFeature_1768635084_6Service {
        [SerializeField] private Feature_1768635084_6View _view;
        private Feature_1768635084_6Model _model;

        public void Initialize() {
            _model = new Feature_1768635084_6Model();
            _view = GetComponent<Feature_1768635084_6View>();
        }
