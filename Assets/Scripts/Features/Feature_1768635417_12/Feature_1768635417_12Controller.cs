using UnityEngine;
namespace BubbleShooter.Features.Feature_1768635417_12 {
    public class Feature_1768635417_12Controller : MonoBehaviour, IFeature_1768635417_12Service {
        [SerializeField] private Feature_1768635417_12View _view;
        private Feature_1768635417_12Model _model;

        public void Initialize() {
            _model = new Feature_1768635417_12Model();
            _view = GetComponent<Feature_1768635417_12View>();
        }
