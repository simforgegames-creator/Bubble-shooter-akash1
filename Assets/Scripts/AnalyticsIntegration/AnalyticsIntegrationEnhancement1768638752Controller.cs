...
namespace BubbleShooter.AnalyticsIntegration
{
    ...
    /// </summary>
    public class AnalyticsIntegrationEnhancement1768638752Controller : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            Debug.Log("AnalyticsIntegrationEnhancement1768638752Controller initialized");
        }
