...
namespace BubbleShooter.AnalyticsIntegration
{
    ...
    /// </summary>
    public class AnalyticsIntegrationEnhancement1768640815Controller : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            Debug.Log("AnalyticsIntegrationEnhancement1768640815Controller initialized");
        }
