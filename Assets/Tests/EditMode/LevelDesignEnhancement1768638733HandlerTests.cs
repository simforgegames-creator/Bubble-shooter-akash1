...
{
    [TestFixture]
    public class LevelDesignEnhancement1768638733HandlerTests
    {
        private LevelDesignEnhancement1768638733Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768638733Handler>();
        }
