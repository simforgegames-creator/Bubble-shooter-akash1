...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768638614ManagerTests
    {
        private GameplayMechanicsEnhancement1768638614Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768638614Manager>();
        }
