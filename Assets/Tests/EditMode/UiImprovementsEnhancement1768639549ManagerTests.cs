...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768639549ManagerTests
    {
        private UiImprovementsEnhancement1768639549Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768639549Manager>();
        }
