...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768638603ManagerTests
    {
        private SocialFeaturesEnhancement1768638603Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768638603Manager>();
        }
