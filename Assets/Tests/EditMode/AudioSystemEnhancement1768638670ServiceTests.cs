...
{
    [TestFixture]
    public class AudioSystemEnhancement1768638670ServiceTests
    {
        private AudioSystemEnhancement1768638670Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768638670Service>();
        }
