...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768639794ControllerTests
    {
        private UiImprovementsEnhancement1768639794Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768639794Controller>();
        }
