...
{
    [TestFixture]
    public class MonetizationEnhancement1768640773ControllerTests
    {
        private MonetizationEnhancement1768640773Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768640773Controller>();
        }
