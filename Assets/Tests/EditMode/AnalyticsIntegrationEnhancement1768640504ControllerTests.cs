...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768640504ControllerTests
    {
        private AnalyticsIntegrationEnhancement1768640504Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768640504Controller>();
        }
