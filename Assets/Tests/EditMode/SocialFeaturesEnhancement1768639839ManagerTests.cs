...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768639839ManagerTests
    {
        private SocialFeaturesEnhancement1768639839Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768639839Manager>();
        }
