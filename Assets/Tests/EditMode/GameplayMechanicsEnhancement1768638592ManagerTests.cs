...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768638592ManagerTests
    {
        private GameplayMechanicsEnhancement1768638592Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768638592Manager>();
        }
