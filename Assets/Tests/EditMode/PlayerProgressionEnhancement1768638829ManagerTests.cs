...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638829ManagerTests
    {
        private PlayerProgressionEnhancement1768638829Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638829Manager>();
        }
