...
{
    [TestFixture]
    public class MonetizationEnhancement1768638723ServiceTests
    {
        private MonetizationEnhancement1768638723Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768638723Service>();
        }
