...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768638771ManagerTests
    {
        private GameplayMechanicsEnhancement1768638771Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768638771Manager>();
        }
