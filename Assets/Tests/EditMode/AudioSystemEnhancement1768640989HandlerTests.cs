...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640989HandlerTests
    {
        private AudioSystemEnhancement1768640989Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640989Handler>();
        }
