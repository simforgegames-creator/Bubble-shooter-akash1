...
{
    [TestFixture]
    public class MonetizationEnhancement1768639633ServiceTests
    {
        private MonetizationEnhancement1768639633Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768639633Service>();
        }
