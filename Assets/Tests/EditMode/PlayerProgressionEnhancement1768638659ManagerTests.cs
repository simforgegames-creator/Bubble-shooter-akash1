...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638659ManagerTests
    {
        private PlayerProgressionEnhancement1768638659Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638659Manager>();
        }
