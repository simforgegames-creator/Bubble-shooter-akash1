...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640266ServiceTests
    {
        private AudioSystemEnhancement1768640266Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640266Service>();
        }
