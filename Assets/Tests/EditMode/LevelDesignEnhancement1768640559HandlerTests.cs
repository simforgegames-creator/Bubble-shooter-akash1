...
{
    [TestFixture]
    public class LevelDesignEnhancement1768640559HandlerTests
    {
        private LevelDesignEnhancement1768640559Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768640559Handler>();
        }
