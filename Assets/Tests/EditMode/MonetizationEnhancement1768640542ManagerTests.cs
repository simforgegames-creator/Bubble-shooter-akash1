...
{
    [TestFixture]
    public class MonetizationEnhancement1768640542ManagerTests
    {
        private MonetizationEnhancement1768640542Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768640542Manager>();
        }
