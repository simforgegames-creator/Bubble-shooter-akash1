...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768639576ManagerTests
    {
        private UiImprovementsEnhancement1768639576Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768639576Manager>();
        }
