...
{
    [TestFixture]
    public class LevelDesignEnhancement1768639667ServiceTests
    {
        private LevelDesignEnhancement1768639667Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768639667Service>();
        }
