...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768639679HandlerTests
    {
        private AnalyticsIntegrationEnhancement1768639679Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768639679Handler>();
        }
