...
{
    [TestFixture]
    public class LevelDesignEnhancement1768638683ManagerTests
    {
        private LevelDesignEnhancement1768638683Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768638683Manager>();
        }
