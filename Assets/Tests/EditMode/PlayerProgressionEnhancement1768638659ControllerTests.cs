...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638659ControllerTests
    {
        private PlayerProgressionEnhancement1768638659Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638659Controller>();
        }
