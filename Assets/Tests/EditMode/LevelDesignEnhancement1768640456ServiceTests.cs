...
{
    [TestFixture]
    public class LevelDesignEnhancement1768640456ServiceTests
    {
        private LevelDesignEnhancement1768640456Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768640456Service>();
        }
