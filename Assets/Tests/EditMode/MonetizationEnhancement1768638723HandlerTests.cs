...
{
    [TestFixture]
    public class MonetizationEnhancement1768638723HandlerTests
    {
        private MonetizationEnhancement1768638723Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768638723Handler>();
        }
