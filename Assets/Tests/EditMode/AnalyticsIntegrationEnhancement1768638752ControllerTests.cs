...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768638752ControllerTests
    {
        private AnalyticsIntegrationEnhancement1768638752Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768638752Controller>();
        }
