...
{
    [TestFixture]
    public class AudioSystemEnhancement1768638861ManagerTests
    {
        private AudioSystemEnhancement1768638861Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768638861Manager>();
        }
