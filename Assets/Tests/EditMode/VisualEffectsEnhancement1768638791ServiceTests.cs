...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768638791ServiceTests
    {
        private VisualEffectsEnhancement1768638791Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768638791Service>();
        }
