...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768639760ManagerTests
    {
        private PlayerProgressionEnhancement1768639760Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768639760Manager>();
        }
