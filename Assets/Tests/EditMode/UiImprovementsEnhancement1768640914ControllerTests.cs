...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768640914ControllerTests
    {
        private UiImprovementsEnhancement1768640914Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768640914Controller>();
        }
