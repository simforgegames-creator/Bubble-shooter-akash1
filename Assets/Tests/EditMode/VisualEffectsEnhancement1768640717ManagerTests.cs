...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640717ManagerTests
    {
        private VisualEffectsEnhancement1768640717Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640717Manager>();
        }
