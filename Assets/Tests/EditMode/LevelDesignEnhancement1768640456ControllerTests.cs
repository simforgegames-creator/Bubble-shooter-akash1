...
{
    [TestFixture]
    public class LevelDesignEnhancement1768640456ControllerTests
    {
        private LevelDesignEnhancement1768640456Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768640456Controller>();
        }
