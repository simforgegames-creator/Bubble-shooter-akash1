...
{
    [TestFixture]
    public class MonetizationEnhancement1768640783HandlerTests
    {
        private MonetizationEnhancement1768640783Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768640783Handler>();
        }
