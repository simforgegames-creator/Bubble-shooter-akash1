...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768638592ServiceTests
    {
        private GameplayMechanicsEnhancement1768638592Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768638592Service>();
        }
