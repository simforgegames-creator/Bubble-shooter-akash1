...
{
    [TestFixture]
    public class AudioSystemEnhancement1768638577ServiceTests
    {
        private AudioSystemEnhancement1768638577Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768638577Service>();
        }
