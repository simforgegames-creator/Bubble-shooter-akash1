...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768639723ManagerTests
    {
        private AnalyticsIntegrationEnhancement1768639723Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768639723Manager>();
        }
