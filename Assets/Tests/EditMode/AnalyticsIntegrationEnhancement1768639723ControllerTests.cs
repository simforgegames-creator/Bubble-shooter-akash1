...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768639723ControllerTests
    {
        private AnalyticsIntegrationEnhancement1768639723Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768639723Controller>();
        }
