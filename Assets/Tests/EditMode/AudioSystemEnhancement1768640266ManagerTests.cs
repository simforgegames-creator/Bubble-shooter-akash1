...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640266ManagerTests
    {
        private AudioSystemEnhancement1768640266Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640266Manager>();
        }
