...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638829ServiceTests
    {
        private PlayerProgressionEnhancement1768638829Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638829Service>();
        }
