...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640632ManagerTests
    {
        private VisualEffectsEnhancement1768640632Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640632Manager>();
        }
