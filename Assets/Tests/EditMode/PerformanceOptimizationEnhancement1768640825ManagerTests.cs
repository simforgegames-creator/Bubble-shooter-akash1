...
{
    [TestFixture]
    public class PerformanceOptimizationEnhancement1768640825ManagerTests
    {
        private PerformanceOptimizationEnhancement1768640825Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PerformanceOptimizationEnhancement1768640825Manager>();
        }
