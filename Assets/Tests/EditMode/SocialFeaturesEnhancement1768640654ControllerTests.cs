...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768640654ControllerTests
    {
        private SocialFeaturesEnhancement1768640654Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768640654Controller>();
        }
