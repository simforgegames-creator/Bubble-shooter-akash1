...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768638636ServiceTests
    {
        private SocialFeaturesEnhancement1768638636Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768638636Service>();
        }
