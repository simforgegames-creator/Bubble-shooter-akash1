...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638829HandlerTests
    {
        private PlayerProgressionEnhancement1768638829Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638829Handler>();
        }
