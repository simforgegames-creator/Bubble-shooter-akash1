...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768639576ControllerTests
    {
        private UiImprovementsEnhancement1768639576Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768639576Controller>();
        }
