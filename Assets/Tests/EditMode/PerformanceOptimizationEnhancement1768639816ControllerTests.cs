...
{
    [TestFixture]
    public class PerformanceOptimizationEnhancement1768639816ControllerTests
    {
        private PerformanceOptimizationEnhancement1768639816Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PerformanceOptimizationEnhancement1768639816Controller>();
        }
