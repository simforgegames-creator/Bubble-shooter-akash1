...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640963ManagerTests
    {
        private VisualEffectsEnhancement1768640963Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640963Manager>();
        }
