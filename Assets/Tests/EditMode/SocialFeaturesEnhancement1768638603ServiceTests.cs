...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768638603ServiceTests
    {
        private SocialFeaturesEnhancement1768638603Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768638603Service>();
        }
