...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640318HandlerTests
    {
        private VisualEffectsEnhancement1768640318Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640318Handler>();
        }
