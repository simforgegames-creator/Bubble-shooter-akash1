...
{
    [TestFixture]
    public class MonetizationEnhancement1768639862ManagerTests
    {
        private MonetizationEnhancement1768639862Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768639862Manager>();
        }
