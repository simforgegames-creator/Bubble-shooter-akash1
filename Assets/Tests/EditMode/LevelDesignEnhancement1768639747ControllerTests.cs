...
{
    [TestFixture]
    public class LevelDesignEnhancement1768639747ControllerTests
    {
        private LevelDesignEnhancement1768639747Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768639747Controller>();
        }
