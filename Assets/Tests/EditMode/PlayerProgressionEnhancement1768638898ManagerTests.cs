...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638898ManagerTests
    {
        private PlayerProgressionEnhancement1768638898Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638898Manager>();
        }
