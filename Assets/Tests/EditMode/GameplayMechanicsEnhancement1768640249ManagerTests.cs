...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768640249ManagerTests
    {
        private GameplayMechanicsEnhancement1768640249Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768640249Manager>();
        }
