...
{
    [TestFixture]
    public class LevelDesignEnhancement1768640952ServiceTests
    {
        private LevelDesignEnhancement1768640952Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768640952Service>();
        }
