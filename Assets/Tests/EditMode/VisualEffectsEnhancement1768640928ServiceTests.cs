...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640928ServiceTests
    {
        private VisualEffectsEnhancement1768640928Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640928Service>();
        }
