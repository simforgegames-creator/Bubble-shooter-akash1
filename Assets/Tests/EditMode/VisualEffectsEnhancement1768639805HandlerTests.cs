...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768639805HandlerTests
    {
        private VisualEffectsEnhancement1768639805Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768639805Handler>();
        }
