...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768640439ManagerTests
    {
        private AnalyticsIntegrationEnhancement1768640439Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768640439Manager>();
        }
