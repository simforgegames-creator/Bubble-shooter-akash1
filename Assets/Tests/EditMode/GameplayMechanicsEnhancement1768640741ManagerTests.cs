...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768640741ManagerTests
    {
        private GameplayMechanicsEnhancement1768640741Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768640741Manager>();
        }
