...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768638791ManagerTests
    {
        private VisualEffectsEnhancement1768638791Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768638791Manager>();
        }
