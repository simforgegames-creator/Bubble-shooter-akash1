...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638742ControllerTests
    {
        private PlayerProgressionEnhancement1768638742Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638742Controller>();
        }
