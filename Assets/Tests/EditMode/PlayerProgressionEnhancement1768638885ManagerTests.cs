...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638885ManagerTests
    {
        private PlayerProgressionEnhancement1768638885Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638885Manager>();
        }
