...
{
    [TestFixture]
    public class PerformanceOptimizationEnhancement1768640620ManagerTests
    {
        private PerformanceOptimizationEnhancement1768640620Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PerformanceOptimizationEnhancement1768640620Manager>();
        }
