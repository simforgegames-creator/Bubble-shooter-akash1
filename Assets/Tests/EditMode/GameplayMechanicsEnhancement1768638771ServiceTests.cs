...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768638771ServiceTests
    {
        private GameplayMechanicsEnhancement1768638771Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768638771Service>();
        }
