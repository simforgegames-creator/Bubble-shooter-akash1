...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640380HandlerTests
    {
        private AudioSystemEnhancement1768640380Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640380Handler>();
        }
