...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768640210HandlerTests
    {
        private SocialFeaturesEnhancement1768640210Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768640210Handler>();
        }
