...
{
    [TestFixture]
    public class LevelDesignEnhancement1768639667ManagerTests
    {
        private LevelDesignEnhancement1768639667Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768639667Manager>();
        }
