...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768638752HandlerTests
    {
        private AnalyticsIntegrationEnhancement1768638752Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768638752Handler>();
        }
