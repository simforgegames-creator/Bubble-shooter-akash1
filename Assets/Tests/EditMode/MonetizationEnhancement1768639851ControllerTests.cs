...
{
    [TestFixture]
    public class MonetizationEnhancement1768639851ControllerTests
    {
        private MonetizationEnhancement1768639851Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768639851Controller>();
        }
