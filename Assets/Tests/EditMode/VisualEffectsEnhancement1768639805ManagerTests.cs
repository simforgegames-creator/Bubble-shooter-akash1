...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768639805ManagerTests
    {
        private VisualEffectsEnhancement1768639805Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768639805Manager>();
        }
