...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638898ServiceTests
    {
        private PlayerProgressionEnhancement1768638898Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638898Service>();
        }
