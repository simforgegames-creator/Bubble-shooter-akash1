...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768640337HandlerTests
    {
        private GameplayMechanicsEnhancement1768640337Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768640337Handler>();
        }
