...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768638703HandlerTests
    {
        private UiImprovementsEnhancement1768638703Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768638703Handler>();
        }
