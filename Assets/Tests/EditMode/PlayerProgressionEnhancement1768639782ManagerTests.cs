...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768639782ManagerTests
    {
        private PlayerProgressionEnhancement1768639782Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768639782Manager>();
        }
