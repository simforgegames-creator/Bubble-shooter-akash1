...
{
    [TestFixture]
    public class PerformanceOptimizationEnhancement1768639654ManagerTests
    {
        private PerformanceOptimizationEnhancement1768639654Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PerformanceOptimizationEnhancement1768639654Manager>();
        }
