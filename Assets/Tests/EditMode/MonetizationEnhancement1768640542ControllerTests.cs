...
{
    [TestFixture]
    public class MonetizationEnhancement1768640542ControllerTests
    {
        private MonetizationEnhancement1768640542Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768640542Controller>();
        }
