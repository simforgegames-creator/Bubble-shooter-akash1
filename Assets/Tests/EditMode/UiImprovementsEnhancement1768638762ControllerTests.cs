...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768638762ControllerTests
    {
        private UiImprovementsEnhancement1768638762Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768638762Controller>();
        }
