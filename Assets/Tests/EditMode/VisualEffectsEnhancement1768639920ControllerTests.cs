...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768639920ControllerTests
    {
        private VisualEffectsEnhancement1768639920Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768639920Controller>();
        }
