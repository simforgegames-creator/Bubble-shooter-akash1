...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768640348HandlerTests
    {
        private AnalyticsIntegrationEnhancement1768640348Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768640348Handler>();
        }
