...
{
    [TestFixture]
    public class AudioSystemEnhancement1768638670ManagerTests
    {
        private AudioSystemEnhancement1768638670Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768638670Manager>();
        }
