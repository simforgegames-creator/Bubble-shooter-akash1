...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640290ManagerTests
    {
        private AudioSystemEnhancement1768640290Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640290Manager>();
        }
