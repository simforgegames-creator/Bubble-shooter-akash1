...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768638752ServiceTests
    {
        private AnalyticsIntegrationEnhancement1768638752Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768638752Service>();
        }
