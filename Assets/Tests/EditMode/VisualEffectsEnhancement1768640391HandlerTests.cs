...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640391HandlerTests
    {
        private VisualEffectsEnhancement1768640391Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640391Handler>();
        }
