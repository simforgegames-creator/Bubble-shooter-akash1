...
{
    [TestFixture]
    public class LevelDesignEnhancement1768639747HandlerTests
    {
        private LevelDesignEnhancement1768639747Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768639747Handler>();
        }
