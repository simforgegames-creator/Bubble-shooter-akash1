...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768638565HandlerTests
    {
        private VisualEffectsEnhancement1768638565Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768638565Handler>();
        }
