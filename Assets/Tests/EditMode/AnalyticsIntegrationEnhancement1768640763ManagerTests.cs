...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768640763ManagerTests
    {
        private AnalyticsIntegrationEnhancement1768640763Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768640763Manager>();
        }
