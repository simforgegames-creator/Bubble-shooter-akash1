...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768638742ManagerTests
    {
        private PlayerProgressionEnhancement1768638742Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768638742Manager>();
        }
