...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768640222ManagerTests
    {
        private UiImprovementsEnhancement1768640222Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768640222Manager>();
        }
