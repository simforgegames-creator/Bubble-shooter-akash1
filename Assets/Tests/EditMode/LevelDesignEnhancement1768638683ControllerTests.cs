...
{
    [TestFixture]
    public class LevelDesignEnhancement1768638683ControllerTests
    {
        private LevelDesignEnhancement1768638683Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768638683Controller>();
        }
