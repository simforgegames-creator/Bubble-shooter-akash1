...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768639563ManagerTests
    {
        private AnalyticsIntegrationEnhancement1768639563Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768639563Manager>();
        }
