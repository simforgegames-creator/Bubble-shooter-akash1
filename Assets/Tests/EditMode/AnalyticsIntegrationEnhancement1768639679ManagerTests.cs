...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768639679ManagerTests
    {
        private AnalyticsIntegrationEnhancement1768639679Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768639679Manager>();
        }
