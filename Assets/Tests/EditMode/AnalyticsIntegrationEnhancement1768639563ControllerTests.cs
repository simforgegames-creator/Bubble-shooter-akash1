...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768639563ControllerTests
    {
        private AnalyticsIntegrationEnhancement1768639563Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768639563Controller>();
        }
