...
{
    [TestFixture]
    public class MonetizationEnhancement1768638723ManagerTests
    {
        private MonetizationEnhancement1768638723Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768638723Manager>();
        }
