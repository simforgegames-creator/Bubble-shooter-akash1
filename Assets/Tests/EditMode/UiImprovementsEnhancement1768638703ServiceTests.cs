...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768638703ServiceTests
    {
        private UiImprovementsEnhancement1768638703Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768638703Service>();
        }
