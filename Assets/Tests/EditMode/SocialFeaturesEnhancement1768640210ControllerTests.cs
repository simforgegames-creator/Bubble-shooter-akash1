...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768640210ControllerTests
    {
        private SocialFeaturesEnhancement1768640210Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768640210Controller>();
        }
