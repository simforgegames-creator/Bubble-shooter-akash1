...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768640973HandlerTests
    {
        private UiImprovementsEnhancement1768640973Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768640973Handler>();
        }
