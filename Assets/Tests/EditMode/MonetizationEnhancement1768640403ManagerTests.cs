...
{
    [TestFixture]
    public class MonetizationEnhancement1768640403ManagerTests
    {
        private MonetizationEnhancement1768640403Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768640403Manager>();
        }
