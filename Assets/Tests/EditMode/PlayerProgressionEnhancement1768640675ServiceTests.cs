...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768640675ServiceTests
    {
        private PlayerProgressionEnhancement1768640675Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768640675Service>();
        }
