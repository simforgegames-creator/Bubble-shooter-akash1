...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768640337ManagerTests
    {
        private GameplayMechanicsEnhancement1768640337Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768640337Manager>();
        }
