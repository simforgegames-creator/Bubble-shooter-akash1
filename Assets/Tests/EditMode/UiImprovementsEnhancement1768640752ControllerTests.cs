...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768640752ControllerTests
    {
        private UiImprovementsEnhancement1768640752Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768640752Controller>();
        }
