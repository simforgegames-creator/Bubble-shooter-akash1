...
{
    [TestFixture]
    public class LevelDesignEnhancement1768640559ManagerTests
    {
        private LevelDesignEnhancement1768640559Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768640559Manager>();
        }
