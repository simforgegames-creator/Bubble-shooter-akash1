...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768639805ControllerTests
    {
        private VisualEffectsEnhancement1768639805Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768639805Controller>();
        }
