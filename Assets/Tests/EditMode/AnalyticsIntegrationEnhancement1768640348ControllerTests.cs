...
{
    [TestFixture]
    public class AnalyticsIntegrationEnhancement1768640348ControllerTests
    {
        private AnalyticsIntegrationEnhancement1768640348Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AnalyticsIntegrationEnhancement1768640348Controller>();
        }
