...
{
    [TestFixture]
    public class LevelDesignEnhancement1768638733ManagerTests
    {
        private LevelDesignEnhancement1768638733Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768638733Manager>();
        }
