...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768639782HandlerTests
    {
        private PlayerProgressionEnhancement1768639782Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768639782Handler>();
        }
