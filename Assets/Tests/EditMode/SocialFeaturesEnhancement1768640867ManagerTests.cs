...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768640867ManagerTests
    {
        private SocialFeaturesEnhancement1768640867Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768640867Manager>();
        }
