...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640318ManagerTests
    {
        private VisualEffectsEnhancement1768640318Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640318Manager>();
        }
