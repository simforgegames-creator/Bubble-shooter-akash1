...
{
    [TestFixture]
    public class LevelDesignEnhancement1768638683ServiceTests
    {
        private LevelDesignEnhancement1768638683Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768638683Service>();
        }
