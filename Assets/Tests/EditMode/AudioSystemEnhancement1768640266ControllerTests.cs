...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640266ControllerTests
    {
        private AudioSystemEnhancement1768640266Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640266Controller>();
        }
