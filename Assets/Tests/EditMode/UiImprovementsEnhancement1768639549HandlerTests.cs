...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768639549HandlerTests
    {
        private UiImprovementsEnhancement1768639549Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768639549Handler>();
        }
