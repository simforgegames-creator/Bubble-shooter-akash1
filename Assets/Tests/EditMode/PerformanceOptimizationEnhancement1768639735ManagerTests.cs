...
{
    [TestFixture]
    public class PerformanceOptimizationEnhancement1768639735ManagerTests
    {
        private PerformanceOptimizationEnhancement1768639735Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PerformanceOptimizationEnhancement1768639735Manager>();
        }
