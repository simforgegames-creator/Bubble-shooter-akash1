...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768640914ManagerTests
    {
        private UiImprovementsEnhancement1768640914Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768640914Manager>();
        }
