...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768638781ManagerTests
    {
        private UiImprovementsEnhancement1768638781Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768638781Manager>();
        }
