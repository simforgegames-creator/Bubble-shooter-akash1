...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768638636ControllerTests
    {
        private SocialFeaturesEnhancement1768638636Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768638636Controller>();
        }
