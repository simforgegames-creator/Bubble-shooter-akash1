...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768640914HandlerTests
    {
        private UiImprovementsEnhancement1768640914Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768640914Handler>();
        }
