...
{
    [TestFixture]
    public class LevelDesignEnhancement1768640456HandlerTests
    {
        private LevelDesignEnhancement1768640456Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<LevelDesignEnhancement1768640456Handler>();
        }
