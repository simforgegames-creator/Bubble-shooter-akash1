...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768640675ManagerTests
    {
        private PlayerProgressionEnhancement1768640675Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768640675Manager>();
        }
