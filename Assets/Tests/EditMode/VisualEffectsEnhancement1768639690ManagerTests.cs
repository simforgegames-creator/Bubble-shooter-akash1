...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768639690ManagerTests
    {
        private VisualEffectsEnhancement1768639690Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768639690Manager>();
        }
