...
{
    [TestFixture]
    public class MonetizationEnhancement1768640403ControllerTests
    {
        private MonetizationEnhancement1768640403Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<MonetizationEnhancement1768640403Controller>();
        }
