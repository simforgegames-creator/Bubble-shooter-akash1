...
{
    [TestFixture]
    public class AudioSystemEnhancement1768640989ControllerTests
    {
        private AudioSystemEnhancement1768640989Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<AudioSystemEnhancement1768640989Controller>();
        }
