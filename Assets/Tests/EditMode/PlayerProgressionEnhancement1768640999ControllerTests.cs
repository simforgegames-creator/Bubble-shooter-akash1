...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768640999ControllerTests
    {
        private PlayerProgressionEnhancement1768640999Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768640999Controller>();
        }
