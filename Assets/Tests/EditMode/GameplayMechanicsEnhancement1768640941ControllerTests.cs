...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768640941ControllerTests
    {
        private GameplayMechanicsEnhancement1768640941Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768640941Controller>();
        }
