...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640706HandlerTests
    {
        private VisualEffectsEnhancement1768640706Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640706Handler>();
        }
