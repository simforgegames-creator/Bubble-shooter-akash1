...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768639644ManagerTests
    {
        private SocialFeaturesEnhancement1768639644Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768639644Manager>();
        }
