...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640632ServiceTests
    {
        private VisualEffectsEnhancement1768640632Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640632Service>();
        }
