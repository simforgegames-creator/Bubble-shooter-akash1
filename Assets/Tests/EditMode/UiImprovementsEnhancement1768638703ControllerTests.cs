...
{
    [TestFixture]
    public class UiImprovementsEnhancement1768638703ControllerTests
    {
        private UiImprovementsEnhancement1768638703Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<UiImprovementsEnhancement1768638703Controller>();
        }
