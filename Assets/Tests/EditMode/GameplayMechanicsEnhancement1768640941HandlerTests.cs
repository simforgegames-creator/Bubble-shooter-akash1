...
{
    [TestFixture]
    public class GameplayMechanicsEnhancement1768640941HandlerTests
    {
        private GameplayMechanicsEnhancement1768640941Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<GameplayMechanicsEnhancement1768640941Handler>();
        }
