...
{
    [TestFixture]
    public class SocialFeaturesEnhancement1768638636HandlerTests
    {
        private SocialFeaturesEnhancement1768638636Handler _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<SocialFeaturesEnhancement1768638636Handler>();
        }
