...
{
    [TestFixture]
    public class PlayerProgressionEnhancement1768640675ControllerTests
    {
        private PlayerProgressionEnhancement1768640675Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PlayerProgressionEnhancement1768640675Controller>();
        }
