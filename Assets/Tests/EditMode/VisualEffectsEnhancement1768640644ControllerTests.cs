...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640644ControllerTests
    {
        private VisualEffectsEnhancement1768640644Controller _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640644Controller>();
        }
