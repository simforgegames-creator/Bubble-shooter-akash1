...
{
    [TestFixture]
    public class PerformanceOptimizationEnhancement1768638625ManagerTests
    {
        private PerformanceOptimizationEnhancement1768638625Manager _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<PerformanceOptimizationEnhancement1768638625Manager>();
        }
