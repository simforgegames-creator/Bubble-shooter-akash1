...
{
    [TestFixture]
    public class VisualEffectsEnhancement1768640278ServiceTests
    {
        private VisualEffectsEnhancement1768640278Service _instance;
        
        [SetUp]
        public void Setup()
        {
            GameObject go = new GameObject();
            _instance = go.AddComponent<VisualEffectsEnhancement1768640278Service>();
        }
